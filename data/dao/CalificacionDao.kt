...
import com.example.animeverse.data.entity.CalificacionEntity
...
interface CalificacionDao {
    ...
    @Query("DELETE FROM calificacion WHERE id_calificacion = :id")
    suspend fun deleteCalificacionById(id: Int)
}
